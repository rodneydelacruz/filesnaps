              ...
              <CardContent className="p-3 space-y-3">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input type="text" value={customSlug} onChange={(e) => setCustomSlug(e.target.value.toLowerCase().replace(/[^a-z0-9-]/g, ''))}
                      ...
                      className="w-full bg-surface border border-border-default px-3 py-2 pr-10 text-sm text-text-primary placeholder:text-text-muted font-mono focus:outline-none focus:border-accent/40 focus:ring-1 focus:ring-accent/20 transition-all"
                    />
                ...
                <div className="space-y-2">
                  ...
                  <input type="number" min="1" step="1" value={maxDownloads} onChange={(e) => setMaxDownloads(e.target.value.replace(/\D/g, ''))}
                    ...
                    className="w-full bg-surface-raised border border-border-default px-3 py-2 text-sm text-text-primary placeholder:text-text-muted focus:outline-none focus:border-accent/40 focus:ring-1 focus:ring-accent/20 transition-all"
                  />
                </div>
              </CardContent>
            </Card>
